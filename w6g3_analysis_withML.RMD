...
covidclass_without_labels <- read.table("../MBI/720/720_regex_mmp/data_do_not_alter/covidclass_without_labels.csv",
                                        na.strings = "", header = TRUE, sep = "\t")
#,
covidclass_w_labels <- read.table("../MBI/720/720_regex_mmp/data_do_not_alter/covidclass_30_percent_labels.csv",
                                        na.strings = "", header = TRUE, sep = "\t")
```
...
write_csv(group_predictions_wk6, "../MBI/720/720_regex_mmp/analysis/group3_predictions_wk6.csv")
...
covidclass_labels <- read.table("../MBI/720/720_regex_mmp/data_do_not_alter/covidclass_30_percent_labels.tsv",
                                header = TRUE, sep = "\t")
