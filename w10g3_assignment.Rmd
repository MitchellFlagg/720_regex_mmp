...
## Model Output
```{r}
#Our COVID prediction is labeled in the column "final_prediction_w10
group3_predictions_wk10 <- week_10_predictions 
write_csv(group3_predictions_wk10, "./analysis/group3_predictions_wk10.csv")
```
