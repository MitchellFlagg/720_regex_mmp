...
covid_dataset7$ontology_id <- gsub( "-L", "", covid_dataset7$ontology_id)
covid_dataset7$ontology_id <- gsub( "-R", "", covid_dataset7$ontology_id)
covid_dataset7$ontology_id <- gsub( "-B", "", covid_dataset7$ontology_id)

#remap to ontology concepts:
covid_dataset8 <- left_join(covid_dataset7, concepts, by=c('ontology_id' = 'conceptID'), ignore_case = TRUE)

#clean unmapped terms to base cheif complaint:
covid_dataset9 <- covid_dataset8%>%
...
covid_dataset9 <- covid_dataset9 %>% select(id, defaultDescription, ontology_id, covid_label)
